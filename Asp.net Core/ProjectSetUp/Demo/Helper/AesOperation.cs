...
namespace TestWeb.Helper
{
    public class AesOperation
    {
        ...
        public static string DiscountString(string plainText, string key, string iv)
        {
            ...
            {
                aes.Key = Encoding.UTF8.GetBytes(key);     //"Lhysds7c4rt93PAUGHl"
        ...
        public static string ResponceEncryptString(string plainText)
        {
